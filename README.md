...
Google Collab Link to run this notebook: https://colab.research.google.com/
...
Just for a sense check so we know the Confusion matrix is correct
...
# Deeper Look into Predictions

Lets use Pandas to put our data into a table and have a deeper look at the predictions and see the instances where the model is getting the answer wrong
